...
export default function MobileMenu(props: any) {
    ...
    const Items: 
    {
        ...
        icon: any, 
        title: String, 
        positionLeft: String, positionTop: String, 
        pages?: {
            title: string;
            href: string;
        }[]
            ...
            <div key="modal" className="MobileMenu">
                <div className="Main">
...

                    {
                        ItemOptions.isInView ? (
                            <Button variant="outlined" className="IconButton White" onClick={handleListClosure}>
                ...
                <AnimatePresence>
                {
                    ItemOptions.isInView ? (
                        ...
                        >
                            {
                                ItemOptions.Type == "Pages" && ItemOptions.Pages != null ? (
                                    ItemOptions.Pages.map((page, index) => {
                                        ...
                                        return (
                                            <>
                                                <Button key={index} className= { "PageButton " + activeState } variant="text" onClick={() => {ChangeRoute(page.href)}}>
                                                    <page.icon/>
                                                    {page.title}
                                                </Button>
                                            </>
                                ...
                                (                                    
                                    Languages.map((lang, index) => {
                                        ...
                                        return (
                                            <Button key={index} className={"LocaleButton " + activeState} variant="text" onClick={() => {handleLocaleClick(lang.locale)}}>
                                                <lang.flag/>
                                                {lang.name}
                                            </Button>
                                        )
                        ...
                        >
                            {
                                Items.map((Item, index) => {
                                    return (
                                        <div key={index} className="Item" id={`${index}`} data-href={Item.href} onClick={(e: any) => {handleClickItem(e)}} data-positionleft={Item.positionLeft} data-positiontop={Item.positionTop} data-pages={ Item.pages? Item.pages : null }>
                                            {Item.icon}
                                            {Item.title}
                                        </div>
                                    )
